...
class Model():
    ...
    def get_language_model_loss(self, lengths, outputs, sequence):
        '''
            ...
            So if sequence was
            ABCED ==> BCED
            And outputs (the GRU outptus)
            12345 ==> 1234

            Where we'd like to have the model learn that 1=B,2=C etc
        '''
        #Tensorflow supports Tensor slciing. Boom
    ...
    def emebd_and_run_rnn(self, lengths, sequence):
        '''
